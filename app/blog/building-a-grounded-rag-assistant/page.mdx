...
<header className="mt-8 mb-10 border-b border-border pb-8">
  ...
  <div className="mt-6 flex flex-wrap gap-3">
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="inline-flex items-center gap-2 rounded-lg border border-border px-4 py-2 text-sm font-medium text-foreground transition-colors hover:border-primary/50 hover:text-primary"
    >
      <FaGithub size={14} />
      Source
    </a>
